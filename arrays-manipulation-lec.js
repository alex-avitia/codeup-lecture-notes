...
function threeBakedPies (pies) {
    return pies.slice(pies.length - 3, pies.length);
}

console.log(threeBakedPies(pies));
...
*/
 ...
 function cleanPhoneNumbers(phoneNums) {
     ...
     //this should remove the dashes for each number
